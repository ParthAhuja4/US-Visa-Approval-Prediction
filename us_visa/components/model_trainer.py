...
class ModelTrainer:
    ...
    def get_model_object_and_report(
        self, train: np.array, test: np.array  # type: ignore
    ) -> Tuple[object, object]:
        """
        ...
        try:
            ...
            metric_artifact = ClassificationMetricArtifact(
                f1_score=f1, precision_score=precision, recall_score=recall  # type: ignore
            )
    ...
    def initiate_model_trainer(
        ...
        try:
            ...
            if (
                best_model_detail.best_score  # type: ignore
            ...
            usvisa_model = USvisaModel(
                preprocessing_object=preprocessing_obj,  # type: ignore
                trained_model_object=best_model_detail.best_model,  # type: ignore
            )
